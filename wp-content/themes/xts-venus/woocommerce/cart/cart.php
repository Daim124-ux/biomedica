...
if ( xts_get_opt( 'update_cart_quantity_change' ) ) {
	$update_cart_btn_classes .= ' xts-hide';
}

do_action( 'woocommerce_before_cart' ); ?>

<div class="xts-cart-wrapper row">
	<form class="woocommerce-cart-form col-lg-8 col-12" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
					...
					if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
						...
						<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
							...
							if ( ! $product_permalink ) {
								echo xts_wp_kses_media( $thumbnail ); // phpcs:ignore XSS ok.
							} else {
		...
		<div class="row xts-cart-actions">
	...
	<div class="xts-cart-totals col-lg-4 col-12">
