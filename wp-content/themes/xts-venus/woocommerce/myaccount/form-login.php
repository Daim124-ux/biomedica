...
if ( 'no' === get_option( 'woocommerce_enable_myaccount_registration' ) ) {
	$login_form_classes .= ' xts-login-only';
}
...
<?php endif; ?>
	...
	<div class="xts-form-login col-sm-12 col-md<?php echo esc_attr( $login_form_classes ); ?>">
		...
		<form class="woocommerce-form woocommerce-form-login login" method="post">
			...
			<p class="form-row">
				...
				<button type="submit" class="woocommerce-button button woocommerce-form-login__submit<?php echo esc_attr( function_exists( 'wc_wp_theme_get_element_class_name' ) && wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" name="login" value="<?php esc_attr_e( 'Log in', 'woocommerce' ); ?>"><?php esc_html_e( 'Log in', 'woocommerce' ); ?></button>
			</p>
