...
<form class="woocommerce-form woocommerce-form-login login<?php echo esc_attr( $wrapper_classes ); ?>" method="post" style="<?php echo esc_attr( $hidden ); ?>" action="<?php echo esc_url( $action ); ?>">
	...
	<p class="form-row xts-login-submit">
		...
		<button type="submit<?php echo esc_attr( function_exists( 'wc_wp_theme_get_element_class_name' ) && wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" class="woocommerce-button button woocommerce-form-login__submit" name="login" value="<?php esc_attr_e( 'Login', 'woocommerce' ); ?>"><?php esc_html_e( 'Login', 'woocommerce' ); ?></button>
	</p>
