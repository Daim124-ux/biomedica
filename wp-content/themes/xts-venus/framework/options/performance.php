...
Options::add_field(
	array(
		...
		'description'        => esc_html__( 'Forces the Elementor "Font Awesome" icon font to be loaded on all pages.', 'xts-theme' ),
		'default'            => '0',
		'class'              => 'xts-col-6',
		'priority'           => 30,
		'status'             => 'deprecated',
		'status_description' => esc_html__( 'Works only if the Elementor "Inline Font Icons" feature is disabled.', 'xts-theme' ),
	)
);
...
Options::add_section(
	array(
		'id'       => 'plugins_performance_section',
		'name'     => esc_html__( 'Plugins', 'xts-theme' ),
		'priority' => 35,
...
Options::add_field(
	array(
		...
		'type'        => 'switcher',
		'section'     => 'plugins_performance_section',
		'name'        => esc_html__( 'WP Rocket delay JS exclusions', 'xts-theme' ),
		'description' => esc_html__( 'Add a list of JS files that don’t need to be delayed to the exclusion list for WP Rocket. It contains JS files for elements like header, mobile menu, and other elements that usually need to be active right after opening the page.', 'xts-theme' ),
		'group'       => esc_html__( 'WP Rocket', 'xts-theme' ),
		'default'     => '0',
		'priority'    => 10,
	)
);
