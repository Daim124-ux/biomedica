						...
						<div class="xts-field-status xts-status-<?php echo esc_attr( $this->args['status'] ); ?><?php echo ! empty( $this->args['status_description'] ) ? ' xts-status-hint' : ''; ?>">
							<span class="xts-status-label">
								<?php if ( 'deprecated' === $this->args['status'] ) : ?>
									<?php esc_html_e( 'Deprecated', 'xts-theme' ); ?>
								<?php endif; ?>
							</span>
							<?php if ( ! empty( $this->args['status_description'] ) ) : ?>
								<div class="xts-tooltips-top">
									<div class="xts-status-icon xf-help-question"></div>
									<div class="xts-tooltip">
										<?php echo esc_html( $this->args['status_description'] ); ?>
									</div>
								</div>
							<?php endif; ?>
						</div>
		...
		if ( isset( $this->args['description'] ) && ! empty( $this->args['description'] ) ) {
			?>
				<p class="xts-description">
					<?php echo wp_kses( $this->args['description'], 'xts_theme_settings' ); ?>
				</p>
			<?php
		}
		?>
