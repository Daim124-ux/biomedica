...
class WC_Layered_Nav extends Widget_Base {
	...
	protected function get_categories() {
		...
		$categories = $wpdb->get_results(
			"SELECT t.term_id AS id, t.name AS post_title, t.slug AS post_url FROM {$wpdb->prefix}terms t LEFT JOIN {$wpdb->prefix}term_taxonomy tt ON t.term_id = tt.term_id WHERE tt.taxonomy = 'product_cat' ORDER BY name"
		); // phpcs:ignore
