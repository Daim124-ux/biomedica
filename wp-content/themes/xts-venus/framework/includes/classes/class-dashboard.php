...
class Dashboard extends Singleton {
	...
	public function submenu_page() {
		...
		add_submenu_page(
			'xts_dashboard',
			esc_html__( 'Patcher', 'xts-theme' ),
			esc_html__( 'Patcher', 'xts-theme' ) . $patcher_count,
			'manage_options',
			'xts_patcher',
			array( $this, 'patcher' )
		);
				...
				<?php if ( ! xts_get_opt( 'white_label', '0' ) ) : ?>
					<div class="xts-col <?php echo esc_attr( $classes ); ?>">
						<div class="xts-welcome-info-box xts-need-help">
							...
							<ul class="xts-list">
								<li>
									<a href="<?php echo esc_url( XTS_SPACE_URL . 'documentation/space' ); ?>" target="_blank">
										<?php esc_html_e( 'Documentation', 'xts-theme' ); ?>
									</a>
								</li>

								<li>
									<a href="<?php echo esc_url( 'https://www.youtube.com/channel/UCu3loFwqqOQ9z-YTcnplK8w' ); ?>" target="_blank">
										<?php esc_html_e( 'Video tutorials', 'xts-theme' ); ?>
									</a>
								</li>

								<li>
									<a href="<?php echo esc_url( xts_get_link_by_key( 'welcome_forum' ) ); ?>" target="_blank">
				...
				<?php if ( ! xts_get_opt( 'white_label', '0' ) && xts_is_build_for_space() ) : ?>
					<div class="xts-col <?php echo esc_attr( $classes ); ?>">
						<div class="xts-welcome-info-box xts-other-themes">
							...
							<a href="<?php echo esc_url( xts_get_link_by_key( 'welcome_all_themes' ) ); ?>" class="xts-btn-success xts-btn-bordered" target="_blank">
					...
					<?php if ( ! xts_get_opt( 'white_label', '0' ) ) : ?>
						<div class="xts-dashboard-video">
							<div class="xts-info">
								...
								<a href="<?php echo esc_url( XTS_DOCS_URL ); ?>header-builder" class="xts-inline-btn" target="_blank">
	...
	public function patcher() {
		...
		$this->header( esc_html__( 'Patcher', 'xts-theme' ), esc_html__( 'Download and apply patches for known bugs and issues.', 'xts-theme' ) );
		
		Client::get_instance()->interface();
		...
		<div class="xts-dashboard-wrapper">
			<div class="xts-dashboard-tabs">
				...
				<ul class="xts-dashboard-tabs-nav">
					...
					<li class="<?php echo isset( $_GET['page'] ) && ! $is_setup && 'xts_patcher' === $_GET['page'] ? 'xts-active' : ''; // phpcs:ignore ?>">
						<a class="xf-patcher<?php echo esc_attr( $link_classes ); ?>" href="<?php echo esc_url( admin_url( 'admin.php?page=xts_patcher' ) ); ?>">
