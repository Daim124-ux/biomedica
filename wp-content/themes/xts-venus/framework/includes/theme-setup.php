...
if ( ! function_exists( 'xts_register_sidebars' ) ) {
	...
	function xts_register_sidebars() {
		...
		$footer_layout  = xts_get_opt( 'footer_layout', 1 );
	...
	function xts_register_required_plugins() {
		...
		if ( ! xts_is_build_for_space() ) {
			$plugins[] = array(
				...
				'slug'     => 'xts-theme-core',
				'required' => true,
				'version'  => XTS_CORE_PLUGIN_VERSION,
				'source'   => get_parent_theme_file_path( './framework/plugins/xts-theme-core.zip' ),
		...
		$plugins[] = array(
			...
			'slug'    => 'revslider',
			'version' => get_option( 'xts_revslider_version', '6.6.20' ),
