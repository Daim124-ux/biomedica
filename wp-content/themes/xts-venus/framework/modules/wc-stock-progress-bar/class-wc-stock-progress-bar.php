	...
	public function add_options() {
		Options::add_field(
			array(
				...
				'description' => 'Display a number of sold and in stock products as a progress bar. <a href="' . esc_url( XTS_DOCS_URL ) . 'products-stock-progress-bar-2" target="_blank">Documentation.</a>',
