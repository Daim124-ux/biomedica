...
class Walker extends Walker_Nav_Menu {
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if ( 1 === $depth && ! strstr( $args->menu_class, 'xts-nav-mobile' ) ) {
			$classes[] .= 'col-auto';
		}
		...
		if ( 0 === $depth && 'sized' === $this->design && $width && ! strstr( $args->menu_class, 'xts-nav-mobile' ) ) {
			$style = ' style="--xts-dropdown-width: ' . $width . 'px;"';
		}
