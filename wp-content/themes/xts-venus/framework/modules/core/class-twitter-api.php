...
class Twitter_API {
	 ...
	 * These are all available by creating your own application on dev.x.com
	...
	public function __construct( array $settings ) {
		if ( ! function_exists( 'curl_init' ) ) {
			throw new \RuntimeException( 'Twitter_API requires cURL extension to be loaded, see: https://curl.haxx.se/docs/install.html' );
		}
		...
		if ( ! isset( $settings['oauth_access_token'] )
			...
			throw new \InvalidArgumentException( 'Incomplete settings passed to Twitter_API' );
		}
	 ...
	 *
	 * @return Twitter_API Instance of self for method chaining
	 */
	 ...
	 * passed to this method. For v1.1, see: https://dev.x.com/docs/api/1.1
	 *
	 * @param string $url           The API url to use. Example: https://api.x.com/1.1/search/tweets.json
	...
	public function buildOauth( $url, $requestMethod ) {
		...
		$oauth_signature          = xts_is_core_module_exists() ? xts_compress( hash_hmac( 'sha1', $base_info, $composite_key, true ) ) : '';
