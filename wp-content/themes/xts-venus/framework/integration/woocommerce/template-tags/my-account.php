...
if ( ! function_exists( 'xts_wc_my_account_widget_template' ) ) {
	...
	function xts_wc_my_account_widget_template() {
		...
		if ( isset( $settings['my-account']['widget_type'] ) && 'top' === $settings['my-account']['widget_type'] ) {
			$position = 'top';
		}
		...
		?>
		<div class="xts-login-side xts-side-hidden woocommerce<?php echo esc_attr( $wrapper_classes ); ?>">
			<?php if ( 'top' === $position ) : ?>
