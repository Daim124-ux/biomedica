...
class Products extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'recently_viewed'  => esc_html__( 'Recently Viewed Products', 'xts-theme' ),
				],
		...
		$this->add_control(
			...
			[
				'label'        => esc_html__( 'Update with AJAX on page load', 'xts-theme' ),
				'description'  => esc_html__( 'Enable this option if you use full-page cache like WP Rocket.', 'xts-theme' ),
				...
				'return_value' => '1',
				'condition'    => [
					'product_source' => 'recently_viewed',
				],
			]
		);
		...
		do_action( 'xts_products_element_after_design', $this );
		...
		$this->add_control(
			'grid_gallery',
			array(
				'label'       => esc_html__( 'Product gallery', 'xts-theme' ),
				...
				'options'     => array(
					...
					'yes'     => esc_html__( 'Yes', 'xts-theme' ),
					'no'      => esc_html__( 'No', 'xts-theme' ),
				),
			)
		);
		...
		$this->start_controls_tab(
			...
			array(
				'label' => esc_html__( 'Desktop', 'xts-theme' ),
			)
		);

		$this->add_control(
			'grid_gallery_control_desktop',
			array(
				'label'   => esc_html__( 'Product gallery controls', 'xts-theme' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'inherit',
				'options' => array(
					'inherit' => esc_html__( 'Inherit', 'xts-theme' ),
					'off'     => esc_html__( 'Disable', 'xts-theme' ),
					'arrows'  => esc_html__( 'Arrows', 'xts-theme' ),
				),
			)
		);
		...
		$this->start_controls_tab(
			...
			array(
				'label' => esc_html__( 'Mobile devices', 'xts-theme' ),
			)
		);

		$this->add_control(
			'grid_gallery_control_mobile',
			array(
				'label'   => esc_html__( 'Product gallery controls', 'xts-theme' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'inherit',
