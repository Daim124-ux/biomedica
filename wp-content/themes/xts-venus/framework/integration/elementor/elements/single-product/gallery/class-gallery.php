...
class Gallery extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'tablet_carousel_enabled',
			array(
				'label'     => esc_html__( 'Carousel on tablet', 'xts-theme' ),
				'type'      => Controls_Manager::SELECT,
				'options'   => array(
					'inherit' => esc_html__( 'Inherit from Theme Settings', 'xts-theme' ),
					'1'       => esc_html__( 'Enable', 'xts-theme' ),
					'0'       => esc_html__( 'Disable', 'xts-theme' ),
				),
				'default'   => 'inherit',
				'condition' => array(
					'thumbnails_gallery_position' => array( 'grid-1', 'grid-2', 'grid-comb' ),
				),
			)
		);

		$this->add_control(
			'mobile_carousel_enabled',
			array(
				'label'     => esc_html__( 'Carousel on mobile', 'xts-theme' ),
				'type'      => Controls_Manager::SELECT,
				'options'   => array(
					'inherit' => esc_html__( 'Inherit from Theme Settings', 'xts-theme' ),
					'1'       => esc_html__( 'Enable', 'xts-theme' ),
		...
		$this->add_control(
			...
			array(
				...
				'condition' => array(
					'thumbnails_gallery_position' => array( 'side', 'bottom' ),
				),
			)
		);
