...
class Framework {
	...
	public function init() {
		...
		if ( xts_is_elementor_installed() ) {
			add_action( 'elementor/init', array( $this, 'init_elementor_helpers_file' ), 20 );
			add_action( 'elementor/widgets/register', array( $this, 'init_elementor' ) );
			add_action( 'elementor/controls/register', array( $this, 'create_controls' ) );
		}
	}
	...
	public function define_constants() {
		$this->define( 'XTS_FRAMEWORK_VERSION', '1.6.0' );
		...
		$this->define( 'XTS_SPACE_URL', 'https://xtemos.com/' );
		$this->define( 'XTS_DEMO_URL', 'https://space.xtemos.com/demo/' );
		$this->define( 'XTS_DOCS_URL', XTS_SPACE_URL . 'docs-topic/' );
		$this->define( 'XTS_API_URL', XTS_SPACE_URL . 'wp-json/xts/v1/' );
		$this->define( 'XTEMOS_API_URL', 'https://xtemos.com/licenses/api/' );
		$this->define( 'XTS_CORE_PLUGIN_VERSION', '1.1.5' );
	}
	...
	public function include_files() {
		...
		// WP Rocket.
		xts_get_file( 'framework/integration/rocket/functions' );

		// WOOCS.
		xts_get_file( 'framework/integration/woocs/functions' );
		...
		xts_get_file( 'framework/includes/options/controls/select-with-table/class-select-with-table' );
		xts_get_file( 'framework/includes/options/controls/responsive-range/class-responsive-range' );
		...
		Modules::register( 'mobile-optimization' );
		Modules::register( 'patcher' );
		...
		Modules::register( 'wc-adjacent-products' );
		Modules::register( 'wc-shipping-progress-bar' );
		Modules::register( 'wc-product-visitor-counter' );
		Modules::register( 'wc-quick-buy' );
		Modules::register( 'wc-unit-of-measure' );
		Modules::register( 'wc-frequently-bought-together' );
		Modules::register( 'wc-dynamic-discounts' );
		Modules::register( 'wc-linked-variation' );
		Modules::register( 'wc-grid-gallery' );
		Modules::register( 'wc-show-single-variations' );
		...
		xts_get_file( 'templates/elementor/marquee' );
	 ...
	 * @since 1.0.0
	 */
	public function create_controls( Controls_Manager $controls_manager  ) {
		...
		xts_get_file( 'framework/integration/elementor/controls/class-css-class' );
	...
	public function init_elementor() {
		if ( isset( $_GET['elementor_updater'] ) ) {
			$this->init_elementor_helpers_file();
		}
		...
		xts_get_file( 'framework/integration/elementor/elements/single-product/shipping-progress-bar/class-shipping-progress-bar' );
		xts_get_file( 'framework/integration/elementor/elements/single-product/visitor-counter/class-visitor-counter' );
		xts_get_file( 'framework/integration/elementor/elements/single-product/frequently-bought-together/class-frequently-bought-together' );
		xts_get_file( 'framework/integration/elementor/elements/single-product/dynamic-discounts/class-dynamic-discounts-table' );
		xts_get_file( 'framework/integration/elementor/elements/single-product/linked-variations/class-linked-variations' );
		...
		xts_get_file( 'framework/integration/elementor/elements/marquee/class-marquee' );
		xts_get_file( 'framework/integration/elementor/elements/nested-carousel/class-nested-carousel' );
	...
	/**
	 * Include elementor helpers files.
	 *
	 * @return void
	 */
	public function init_elementor_helpers_file() {
		// Default elements.
		...
		xts_get_file( 'framework/integration/elementor/default-elements/container' );
