...
return array(
	...
	'menu-sticky-offsets'                 => array(
		array(
			'title'     => esc_html__( 'Menu sticky dropdown offsets script', 'xts-theme' ),
			'name'      => 'menu-sticky-offsets',
			'file'      => '/js/scripts/menuStickyOffsets',
			'in_footer' => true,
		),
	),
	'menu-mobile'                         => array(
	...
	'age-verify'                          => array(
		array(
			'title'     => esc_html__( 'Age verify script', 'xts-theme' ),
			'name'      => 'age-verify-method',
			'file'      => '/js/scripts/ageVerify',
			'in_footer' => true,
		),
	),
	...
	'preloader'                           => array(
		array(
			'title'     => esc_html__( 'Preloader script', 'xts-theme' ),
			'name'      => 'preloader',
			'file'      => '/js/scripts/preloader',
			'in_footer' => true,
		),
	),
	'promo-popup'                         => array(
	...
	'sticky-container'                    => array(
		array(
			'title'     => esc_html__( 'Sticky container script', 'xts-theme' ),
			'name'      => 'sticky-container-method',
			'file'      => '/js/scripts/stickyContainer',
			'in_footer' => true,
		),
	),
	...
	'product-visitor-counter'             => array(
		array(
			'title'     => esc_html__( 'Product visitor counter', 'xts-theme' ),
			'name'      => 'product-visitor-counter',
			'file'      => '/js/scripts/productVisitorCounter',
			'in_footer' => true,
		),
	),
	'product-recently-viewed'             => array(
		array(
			'title'     => esc_html__( 'Product recently viewed', 'xts-theme' ),
			'name'      => 'product-recently-viewed',
			'file'      => '/js/scripts/productRecentlyViewed',
			'in_footer' => true,
		),
	),
	'frequently-bought-together'          => array(
		array(
			'title'     => esc_html__( 'Frequently bought together', 'xts-theme' ),
			'name'      => 'frequently-bought-together',
			'file'      => '/js/scripts/frequentlyBoughtTogether',
			'in_footer' => true,
		),
	),
	'dynamic-discounts'             => array(
		array(
			'title'     => esc_html__( 'Dynamic Discount', 'xts-theme' ),
			'name'      => 'dynamic-discounts',
			'file'      => '/js/scripts/dynamicDiscounts',
			'in_footer' => true,
		),
	),
	'product-image-gallery-in-loop'       => array(
		array(
			'title'     => esc_html__( 'Images gallery in product loop', 'xts-theme' ),
			'name'      => 'image-gallery-in-loop',
			'file'      => '/js/scripts/productImagesGalleryInLoop',
			'in_footer' => true,
		),
	),
	'cart-quantity'                       => array(
		array(
			'title'     => esc_html__( 'WooCommerce cart quantity', 'xts-theme' ),
			'name'      => 'cart-quantity',
			'file'      => '/js/scripts/cartQuantity',
			'in_footer' => true,
		),
	),
);
